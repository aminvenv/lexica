...
def main(args):
    ...
    if args.run_path:
        ...
        dt_embedding = np.dtype((np.float16, (MODEL_VOCAB_SIZE,)))
    ...
    tokenizer = BertTokenizerFast.from_pretrained(TOKENIZER, cache_dir=".cache") 
    ...
    for i in tqdm(range(num_iter), desc="Indexing passages"):
        ...
        passage_token_ids = tokenizer(batch_text, 
                                      max_length=512, # added by optimus
        ...
        passage_inputs = tokenizer(batch_text, 
                                   max_length=512,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--ckpt_path_or_name", type=str, default="")
